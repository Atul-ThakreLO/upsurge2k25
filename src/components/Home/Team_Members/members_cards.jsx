...
export function MemberCard({ name, position, imageUrl, instagramUrl, linkedinUrl, index }) {
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              >
                <img
                  ...
                  alt={`${name} profile`}
                  className="w-60 h-70 rounded-lg border-3 border-white shadow-lg object-cover transition-all duration-300 group-hover:shadow-pink-500/30"
                />
              </div>
