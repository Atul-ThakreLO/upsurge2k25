...
const RegisterButton = () => {
  return (
    <button className="relative pink-shadow border-pink-100 border-2  bg-pink-700 hover:bg-pink-900 text-pink-200 font-squid cursor-pointer font-bold tracking-widest px-10 py-5 rounded-lg text-xl transition-colors duration-300 overflow-hidden w-72 h-16 group">
