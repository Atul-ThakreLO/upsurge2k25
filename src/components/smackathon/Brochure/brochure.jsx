...
const Brochure = () => {
  ...
  return (
    <>
      <section className="relative font-mono bg-no-repeat bg-cover bg-center bg-[url('https://res.cloudinary.com/dok1hsojb/image/upload/v1754644112/brochure-bg_upscaled_q15ozp.jpg')] py-10 ">
        ...
        <div className="py-10 text-white text-center w-full relative z-[2]">
          <p ref={titleRef} className="text-5xl font-squid">
            Brochure
          </p>
          <p
            ref={subTextRef}
          ...
          >
            ...
            <div ref={brochureCard} className="brochureCard">
              <div className="p-4 h-full flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-squid md:text-3xl font-bold text-white mb-2 drop-shadow-lg">
                  Brochure
                </h3>
