...
export default function Tracks() {
  ...
  return (
    <div
      className={`bg-black py-20 px-4 sm:px-10 min-h-screen text-white tracking-wider relative overflow-hidden ${
    ...
    >
      ...
      >
        <div className="flex items-center justify-center space-x-6 mb-8">
          ...
          <h1
            className={`text-4xl md:text-6xl font-squid font-extrabold text-pink-500 uppercase tracking-widest game-text ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {tracks.slice(0, 6).map((track, index) => {
            ...
            const survivalRate = Math.round(
              (track.players / (track.players + track.eliminated)) * 100
            );
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${colorClasses.gradient} opacity-0 group-hover:opacity-20 transition-all duration-700 blur-sm`}
                ></div>
                ...
                <div className="relative z-10 mt-8">
                  ...
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <div
                        className={`text-xs font-mono ${colorClasses.text} opacity-75`}
                      >
                        SURVIVAL PROTOCOL
                      </div>
                    </div>
                  ...
                  <p className="text-gray-300 mt-3 text-sm leading-relaxed group-hover:text-pink-200 transition-colors duration-500 break-words [hyphens:auto] text-justify">
                    {track.description}
                  </p>
        ...
        <div className="inline-block bg-gradient-to-r from-pink-600 via-red-600 to-pink-600 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-pink-200 text-lg mb-6 font-mono">
              The stakes are absolute. Once you enter, there&#39;s no turning
              back.
            </p>
      ...
      <style jsx>{`
        ...
        @keyframes glitch {
          ...
          90% {
            transform: skew(-0.5deg) translateX(-0.5px);
          }
          100% {
            transform: skew(0deg) translateX(0);
          }
